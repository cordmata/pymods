...
class ModsRoot(object):
    ...
    def __init__(self, collection=False):
        self._me = ElementMaker(namespace=MODS_NAMESPACE, 
...
class Mods(ModsRoot):
    ...
    def add_name(self, last, rest=None, roles=None, is_institution=False):
        ...
        @param roles: a list of strings that designate this entity's relation
            to the resource
        @param is_institution: indicates whether this is a corporate name or not
        '''
        name = self._me.name()
        if is_institution:
    ...
    def add_location_url(self, url, date_last_accessed=None, 
        ...
        '''@see: http://www.loc.gov/standards/mods/v3/mods-userguide-elements.html#url'''
